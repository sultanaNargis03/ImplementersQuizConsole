...
public class Question
{
	...
	public Question(Integer id, String category, String questionTitle, String difficultyLevel, String option1,
	...
	public String toString() {
		return "Question [id=" + id + ", category=" + category + ", questionTitle=" + questionTitle
